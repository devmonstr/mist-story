...
export default function SupportPage() {
  ...
  const faqs = [
    {
      id: '1',
      question: 'How do I sign in to Myth Story?',
      answer: 'Myth Story uses Nostr NIP-07 for authentication. You\'ll need a compatible browser extension like Alby, nos2x, or Nostr Connect. Visit our Sign In page and click "Connect with Nostr" to authenticate using your extension.',
    },
    {
      id: '2',
      question: 'How can I publish my novel on Myth Story?',
    ...
    {
      id: '3',
      question: 'Is my content secure on Myth Story?',
    ...
    },
    {
      ...
      answer: 'If you encounter content that violates our community guidelines, please use the report button on the content page or contact us at support@mythstory.app with details.',
    },
    {
      id: '6',
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-12">
          <div className="border border-border/40 rounded bg-card p-6 flex flex-col items-center text-center">
            ...
            <Button variant="outline" asChild className="w-full">
              <a href="mailto:support@Myth Story.app">Send Email</a>
            </Button>
          </div>
