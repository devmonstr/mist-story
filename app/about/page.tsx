        ...
        <section className="border-b border-border/40 px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Inkwell exists to democratize storytelling. We believe every voice deserves to be heard, and every reader should have access to exceptional stories. Our platform removes barriers between writers and their audiences, fostering a community where creativity thrives.
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-border/40 px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mb-8 text-muted-foreground">
              Inkwell was founded by a team of writers, readers, and technologists who believe that stories matter. We're passionate about creating a space where creativity can flourish without compromise.
            </p>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Whether you're a reader seeking inspiration or a writer ready to share your work, Inkwell is your home.
            </p>
