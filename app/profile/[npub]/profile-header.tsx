...
export function ProfileHeader({ params }: { params: Promise<{ npub: string }> }) {
      ...
      <div className="border-b border-border">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-6 sm:grid-cols-4">
            <div>
              <div className="text-2xl font-semibold text-foreground">{authorStats.novels}</div>
            ...
            <div>
              <div className="text-2xl font-semibold text-foreground">
                <Link href={`/profile/${npub}/followers`} className="hover:underline">
                  {authorStats.followers.toLocaleString()}
                </Link>
              </div>
            ...
            <div>
              <div className="text-2xl font-semibold text-foreground">{authorStats.reads.toLocaleString()}</div>
